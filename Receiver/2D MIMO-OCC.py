...
while cap.isOpened():
    ...
    if success:
        ...
        if bit[0:8]==[1,0,0,1,1,0,0,1]:
            ...
            cv2.putText(crop, "Distance: " + str(dis1) + "cm", (50,110 ), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
            cv2.putText(crop, "Vibration: " + str(vib1) + "Hz", (50,140 ), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
